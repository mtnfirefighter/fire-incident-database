...
def _clear_write_report_form_state():
    """Clear Write Report form state only."""
    for k in list(st.session_state.keys()):
        if k.startswith(('w_', 'editor_incident_', 'btn_save_incident_')):
...
if st.button("New Report (Clear)", type="secondary", key="w_clear_report"):
